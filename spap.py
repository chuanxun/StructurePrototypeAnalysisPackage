...
def analyze(symprec=0.1, e_range=0.4, total_struc=None, l_comp=True, threshold=None, r_cut_off=9.0, extend_r=1.0,
            ilat=2, ccf_step=0.02, l_db=True, l_cif=False, l_poscar=False, l_view=False, work_dir='./', i_mode=1):
    '''
            ...
            for name in files:
                ...
                if 'OUTCAR' in name:
                    try:
                        ...
                        i += 1
                        if debug:
                            e_list.append([0, structure_list[-1].calc.results['energy'] / len(structure_list[-1].numbers),
