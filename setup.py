...
setup(
    ...
    license='GPL',
    author='Chuanxun Su',
    author_email='sucx@ustc.edu.cn',
    keywords=["crystal structure", 'prototype', 'spap', 'similarity comparison', "clustering",
              'pattern recognition', 'AI', 'structure prediction', 'DFT', 'CALYPSO'],
